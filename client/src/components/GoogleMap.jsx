...
//             address={"צימר " + this.props.address }
//           />
//           <InfoWindow
      ...
      <div className="showmap">
        ...
        >
          ...
          <Marker
            ...
            position={{ lat: this.props.lat, lng: this.props.lng }} // Set the position for the marker
          />
          <InfoWindow
            marker={this.state.activeMarker}
            visible={this.state.showingInfoWindow}
          ...
          >
            <div>
              <h4>{this.state.selectedPlace.name}</h4>
              <p>{this.props.address}</p> {/* Display the address in the InfoWindow */}
            </div>
          </InfoWindow>
        </Map>
      </div>
