...
import { useAuth } from '../../hook/AuthProvider.jsx';
import { TextField, Button } from '@mui/material'; // Import required components from Material-UI
...
function EditingGlassesDetails() {
    ...
    const handleConfirmChanges = () => {
        // You can display a confirmation dialog to ask the client to confirm the changes
        // If confirmed, update the database with the editedEyeglasses data
        // Make the necessary API call to save the changes
    };
                ...
                <div id="container">
                    <div id="title">
                        <TextField
                            ...
                            disabled={!isEditing}
                        />
                        {/* Other TextFields for company, price, model, color, etc. */}
                    </div>

                    <Button onClick={handleConfirmChanges} variant="contained" color="primary">
                        Confirm Changes
                    </Button>
                    {isEditing || <Button onClick={handleEdit} variant="contained">Edit Details</Button>}
                </div>
            </div>
        </>
    );
