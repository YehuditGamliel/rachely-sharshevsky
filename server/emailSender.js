...
//   const styledEmailContent = fs.readFileSync(path.resolve(__dirname, 'template', 'templates.html'), 'utf8');
...
// C:\Users\The user\rachely-sharshevsky-7\server\template\templates.html
   ...
   const styledEmailContent = fs.readFileSync('C:\\Users\\The user\\rachely-sharshevsky-9\\server\\templates\\templates.html', 'utf8');
   const replacedEmailContent = styledEmailContent.replace('${emailBody}', emailBody).replace('${params}', params).replace('${mail}', process.env.MAIL_EMAIL);
